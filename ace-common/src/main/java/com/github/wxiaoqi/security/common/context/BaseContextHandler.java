...
public class BaseContextHandler {
    ...
    public static String getUserID(){
        Object value = get(UserConstant.CONTEXT_KEY_USER_ID);
        return StringHelper.getObjectValue(value);
    }

    public static String getUsername(){
        Object value = get(UserConstant.CONTEXT_KEY_USERNAME);
        return StringHelper.getObjectValue(value);
    }

    public static String getName(){
        Object value = get(UserConstant.CONTEXT_KEY_USER_NAME);
        return StringHelper.getObjectValue(value);
    }
    ...
    public static void setName(String name){set(UserConstant.CONTEXT_KEY_USER_NAME,name);}
